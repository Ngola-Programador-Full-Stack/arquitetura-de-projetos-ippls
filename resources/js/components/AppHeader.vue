                ...
                <div class="ml-auto flex items-center space-x-2">
                    <div class="relative flex items-center space-x-1">
                        ...
                        <TooltipProvider :delay-duration="0">
                            <Tooltip>
                                <TooltipTrigger>
                                    <Button variant="ghost" size="icon" as-child class="group relative h-9 w-9 cursor-pointer">
                                        <Link href="/notificacoes">
                                            ...
                                            <Badge 
                                                ...
                                                variant="destructive"
                                                size="sm"
                                                class="absolute -top-1 -right-1 min-w-[18px] h-[18px] flex items-center justify-center p-0"
                                            >
