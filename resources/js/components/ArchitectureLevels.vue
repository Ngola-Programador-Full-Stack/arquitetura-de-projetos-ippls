...
const architectureLevels = [
    {
        ...
        features: ['Modelos básicos (Models)', 'Páginas simples (Views)', 'Controladores essenciais (Controllers)', 'Configuração mínima (Config)', 'Rotas básicas (index.php)', 'CRUD para Teste'],
    ...
    },
    {
        ...
        icon: Database,
        description: 'MVC completo com Composer e helpers',
        features: [
            'Models + Psr-4 Autoload',
            'Views + Layouts Compartilhado',
            'Controllers + Sistema de Rotas',
            'Kits de Setup Iniciais',
            'CRUD Completo para Teste',
            'Vendor/ & Assets/',
        ],
