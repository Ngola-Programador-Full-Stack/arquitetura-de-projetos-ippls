<template>
  <Head title="Inscrição em Projeto" />
      ...
      <div class="flex justify-between items-center">
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-1">
            Inscreva-se no projeto e escolha o nível de arquitetura
          </p>
        </div>
        <Button variant="outline" @click="$inertia.visit(route('inscricoes.index'))">
      ...
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Escolha o nível de arquitetura e adicione informações sobre o seu projeto
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="flex justify-end gap-3 pt-6 border-t">
                <Button
                  type="button"
                  variant="outline"
                  @click="$inertia.visit(route('inscricoes.index'))"
                >
                  Cancelar
                </Button>
                <Button
                ...
                >
                  ...
                  {{ form.processing ? 'Inscrevendo...' : 'Confirmar Inscrição' }}
                </Button>
              </div>
            </form>
          </CardContent>
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Inscrição',
    href: `/inscricoes/projeto/${props.projeto.id}/inscricao`
  }
]
...
const submit = () => {
  form.post(route('inscricoes.store', props.projeto.id), {
    onFinish: () => form.reset(),
  })
}
</script>